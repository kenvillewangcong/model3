...
public class HomeWorkController {
    ...
    public void handler04(HttpServletRequest request, HttpServletResponse response, String username){
        System.out.println("我是handler04，Controller配置允许zhangsan,lisi,wangwu访问");
    }
